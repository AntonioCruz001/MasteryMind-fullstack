    ...
    return (
        <>
            <div className="min-h-screen w-full bg-brandBg flex items-center justify-center relative py-16 px-4">
                <Link
                    to={"/"}
                    className="absolute top-6 left-6 flex items-center gap-2 text-sm font-medium text-gray-500 hover:text-brandPrimary transition-colors z-10"
                ...
                <div className='w-full max-w-sm bg-brandCard p-8 rounded-2xl shadow-md border border-gray-100 mt-4'>
                    ...
                    <form method='post' className='flex flex-col gap-5'>
                        <div className='flex flex-col gap-1.5'>
                            <label className={classesLabels}>Nome</label>
                        ...
                        <div className='flex flex-col gap-1.5'>
                            <label className={classesLabels} htmlFor="">Digite a senha novamente</label>
                            <input type="password" className={classesInputs} placeholder="........" />
                        </div>
